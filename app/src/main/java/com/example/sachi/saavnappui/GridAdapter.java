...
public class GridAdapter extends ArrayAdapter<Songs> {
    private ArrayList<Songs> list;
    private int resource;
    private Context context;

    public GridAdapter(@NonNull Context context, int resource, @NonNull ArrayList<Songs> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        RoundedImageView image = (RoundedImageView) v.findViewById(R.id.imageview);
