...
public class RecommendedRecyclerAdapter extends RecyclerView.Adapter<RecommendedRecyclerAdapter.MyViewHolder> {
    ...
    public RecommendedRecyclerAdapter(ArrayList<Songs> list){
        this.list=list;
    }
    @Override
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(holder.itemView.getContext(), "Selected "+list.get(position).getName(), Toast.LENGTH_SHORT).show();
            }
        });
    }
